                ...
                if (node->layer != Layer_TRANS) {
                    ...
                    switch (node->proto) {
                        case TCP:
                            ...
                            for (char &ch: *opt) {
                                switch (ch) {
                                    case 'F': tcp_hdr->flags.FIN = 1;break;
                                    case 'S': tcp_hdr->flags.SYN = 1;break;
                                    case 'R': tcp_hdr->flags.RST = 1;break;
                                    case 'P': tcp_hdr->flags.PSH = 1;break;
                                    case 'A': tcp_hdr->flags.ACK = 1;break;
                                    case 'U': tcp_hdr->flags.URG = 1;break;
                                    default: break;
                                }
                            }
                        default:
