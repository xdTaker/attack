...
int bird_kill()
{
    ...
    serv_addr.sin_addr.s_addr = inet_addr("192.168.66.214");  //具体的IP地址
    ...
    target_1.sin_port=clnt_addr.sin_port;//客户端端口
    target_1.sin_addr.s_addr=clnt_addr.sin_addr.s_addr;//客户端地址
    target_2.sin_family=AF_INET;
    target_2.sin_port=serv_addr.sin_port;//服务器端口
    target_2.sin_addr.s_addr=serv_addr.sin_addr.s_addr;//服务器地址
